...
int main() {
	...
	unsigned int faceMap = loadTexture("resources/textures/awesomeface.png");
	...
	lightingShader.setInt("material.hhhTex", 1);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		lightingShader.setVec3("pointLights[3].lightColor", pointLightColor[0], pointLightColor[1], pointLightColor[2]);
		...
		glActiveTexture(GL_TEXTURE1);
		glBindTexture(GL_TEXTURE_2D, faceMap);
		glBindVertexArray(cubeVAO);
